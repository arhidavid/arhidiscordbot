...
client.on('message', function() {
    if (message.content === "$loop") { 
      var interval = setInterval (function () {
        bot.sendMessage(message.channel, "Please, note: This channel is for reporting in-game issues, such as problems with claims, animations, certain actions, characters getting stuck and other issues of type that you experienced during your gameplay.
